...
userSchema.virtual('tasks', {
    ref: 'Task',
    localField : '_id',       //field in our collection (user) that is the receiving end of the foreign key
    foreignField : 'owner'    //field in the other collection that point to our field
})

userSchema.methods.getPublicProfile = function(){
    const user = this
    const userObject = user.toObject() //This method returns a cloned, vanilla object.
